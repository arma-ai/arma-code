          ...
          <div>
             ...
             <div className="grid grid-cols-3 gap-2 md:gap-4">
               ...
               <button
                 ...
                 className={`py-3 rounded-xl border transition-colors ${difficulty === 'medium' ? 'bg-primary/20 border-primary text-primary' : 'bg-white/5 border-transparent text-white/60 hover:bg-white/10'}`}
               >
                 Medium
               </button>
               <button
                 onClick={() => setDifficulty('hard')}
                 className={`py-3 rounded-xl border transition-colors ${difficulty === 'hard' ? 'bg-red-500/20 border-red-500 text-red-400' : 'bg-white/5 border-transparent text-white/60 hover:bg-white/10'}`}
               >
                 Hard
               </button>
             </div>
  ...
  return (
    <div className="flex flex-col h-full bg-[#0C0C0F]">
       ...
       <div className="h-14 md:h-16 flex items-center justify-between px-4 md:px-8 border-b border-white/5 bg-[#121215]/50 backdrop-blur-md">
          ...
          <button className="cursor-pointer text-white/40 hover:text-white flex items-center gap-2">
            <Pause size={16} /> Pause
          </button>
       </div>
