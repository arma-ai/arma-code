...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1D1D1F] font-sans selection:bg-black/10">
      ...
      <section className="pt-48 pb-32 text-center px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link
              href="/login"
              className="px-8 py-3 rounded-full bg-[#B8B8B8] text-black font-semibold hover:bg-[#A0A0A0] transition-all min-w-[160px]"
            >
              Start Learning
            </Link>
            <a
      ...
      <section id="how-it-works" className="py-20 max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16 mb-32">
          <div className="flex-1">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-100">
        ...
        <div className="text-center mb-32">
          ...
          <div className="bg-white p-4 rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <div className="bg-[#F5F5F7] p-8 rounded-3xl h-64 flex flex-col justify-between hover:bg-gray-100 transition-colors">
              <h3 className="text-xl font-bold uppercase tracking-wide">AI CHAT BOX</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Ask anything about the material and our AI will get you an answer with explanation.</p>
            </div>
            <div className="bg-[#F5F5F7] p-8 rounded-3xl h-64 flex flex-col justify-between hover:bg-gray-100 transition-colors">
              <h3 className="text-xl font-bold uppercase tracking-wide">FLASHCARDS</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Generate flashcards to learn new words and other information from material faster.</p>
            </div>
            <div className="bg-[#F5F5F7] p-8 rounded-3xl h-64 flex flex-col justify-between hover:bg-gray-100 transition-colors">
              <h3 className="text-xl font-bold uppercase tracking-wide">QUIZZES</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Test your knowledge about the material with AI generated quizzes.</p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#F5F5F7] p-8 rounded-3xl h-48 flex flex-col justify-between hover:bg-gray-100 transition-colors">
              <h3 className="text-xl font-bold uppercase tracking-wide">AI PODCASTS</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Generate ready-to-listen AI podcasts to better understand the material. Good for learning while you are doing other stuff.</p>
            </div>
            <div className="bg-[#F5F5F7] p-8 rounded-3xl h-48 flex flex-col justify-between hover:bg-gray-100 transition-colors">
              <h3 className="text-xl font-bold uppercase tracking-wide">AUTO PRESENTATIONS</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Create high quality presentations with AI about the material and easily export it into PPTX or PDF formats.</p>
            </div>
          </div>
        </div>
      </section>
